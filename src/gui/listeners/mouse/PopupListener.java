...
public class PopupListener implements MouseListener{
	...
	public void mouseClicked(MouseEvent arg0) {
		if (SwingUtilities.isRightMouseButton(arg0)){
		    ...
		    popup.add(gui.Frame.getInstance().getActionManager().getCutAction());
		    popup.add(gui.Frame.getInstance().getActionManager().getCopyAction());
		    popup.add(gui.Frame.getInstance().getActionManager().getPasteAction());
		    popup.add(gui.Frame.getInstance().getActionManager().getShareAction());
		    popup.add(gui.Frame.getInstance().getActionManager().getOpenNodeAction());
		    popup.add(gui.Frame.getInstance().getActionManager().getSaveNodeAction());
